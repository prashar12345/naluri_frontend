...
const SelectdateModal = ({ form, setform, searchSlote, slotLoader, slots }) => {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <button type="button" id="closeselectdateModal" className="close modalCloseJS" data-dismiss="modal" aria-label="Close" title="Close">
                            <span aria-hidden="true" className="modalCloseJS">&times;</span>
                        </button>
                    </div>
                    <form onSubmit={formSubmit}>
                        <div className="modal-body">
                            <div className="form-row">
                                <div className="col-md-6 mb-3">
                                    <label>{languagesModel.translate('select_date_text', language)}</label><br />
                                    {/* {form && form.scheduleDate} */}
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="submit" className="btn btn-primary">{languagesModel.translate('book_text', language)}</button>
                        </div>
                    </form>
                </div>
            </div>
