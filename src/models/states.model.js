...
const name = (isoCode, countryCode) => {
    let ext = list.find(itm => itm.isoCode === isoCode && itm.countryCode === countryCode)
    let value = ext ? ext.name : isoCode
    return value
}

const stateModel = { name, list }
